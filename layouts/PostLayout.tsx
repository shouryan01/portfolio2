					...
					<div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-700 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
						...
						<footer>
							...
							<div className="sticky top-0 pt-4 xl:pt-8">
								<Link
									href={`/${basePath}`}
									className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 static hover:underline"
								...
								<div className="space-y-2 mt-4">
									{ids.map((id) => (
										<div key={id.title} className="block">
											<Link
												href={`#${id.id}`}
												className="text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 hover:underline"
											>
												{id.title}
											</Link>
										</div>
